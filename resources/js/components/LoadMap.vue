          ...
          <l-map 
            ...
            >
                ...
                > 
                    ...
                    <l-popup :lat-lng="item"  :content="`<strong>${__('messages.city.name')}</strong>: ${item.name} <br> <strong>${__('messages.humidity')}</strong>:${item.humidity} <br> <strong>${__('messages.weather')}</strong> ${item.tiempo.description}`"/>
                </l-marker>
